...
**注意：
发送get请求时，若需要传递多个参数，需要把URL以字符串的形式传递，否则只能解析到第一个参数。例如：

ab -c 10 -n 100 "http://mobile.app.autohome.com.cn/discover_v7.5.0/mobile/getcardlist.ashx?a=2&pm=1&v=7.3.0&pid=110000&cid=110100&lat=39.985564&lng=116.318662&uid=0&deviceid=test35519112070873360&pageindex=1&pagesize=20&hid=&state=1"
**
